...
public class RayTests {
	...
	public void testFindClosestPoint() {
		...
		assertEquals("bad ClosestPoint :point in the middle of the list", new Point3D(0,0,0.5), ray.findClosestPoint(points));
	   ...
	   // TC11:Empty list (method should return null value)
		...
		assertEquals("bad ClosestPoint :point in the beginning of the list", new Point3D(0,0,0.5), ray.findClosestPoint(points));
		...
		assertEquals("bad ClosestPoint :point in the end of the list", new Point3D(0,0,0.5), ray.findClosestPoint(points));
